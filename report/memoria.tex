...
\begin{table}[H]
 ...
 Maturity, $T$ & 1 year \\
 \hline
 Risk-free rate, $r$ & 5.0\% p.a. \\
 \hline
 Volatility, $\sigma$ & 20\% p.a.\\
 \hline
 \end{tabular}
\end{table}
...
As the model incorporates stochastic volatility and interest rate models, the resulting price surfaces differ from the Black-Scholes solution,
...
\(1.30\times10^{-3}\), which is acceptable for practical applications, but worse than the European cases. This can be 
